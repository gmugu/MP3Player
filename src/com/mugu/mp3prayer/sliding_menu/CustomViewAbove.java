package com.mugu.mp3prayer.sliding_menu;

import java.util.ArrayList;
import java.util.List;

import com.mugu.mp3prayer.sliding_menu.SlidingMenu.OnClosedListener;
import com.mugu.mp3prayer.sliding_menu.SlidingMenu.OnOpenedListener;
...
public class CustomViewAbove extends ViewGroup {
	...
	public static class SimpleOnPageChangeListener implements
		...
		public void onPageScrolled(int position, float positionOffset,
				int positionOffsetPixels) {
			// This space for rent
			if (mOnMenuMovingListener != null) {
				mOnMenuMovingListener.onMenuMoving(position, positionOffset,
	...
	public interface OnMenuMovingListener {
		public void onMenuMoving(int position, float positionOffset,
				int positionOffsetPixels);
	}

	public void setOnMenuMovingListener(OnMenuMovingListener I) {
